...
<body>
	...
	<div class="container">
		<div class="row-fluid">
			...
			<form class="log-page" action="${pageContext.request.contextPath}/getEmailUpass.htmlx"/>
			...
			<div class="input-prepend">
				...
				<input class="input-xlarge" type="password" name="upass" id="upass" value="${upass }" placeholder="请输入您的原密码" />
			</div>
			<div class="input-prepend">
				<span class="add-on">新密码:</span> 
				<input class="input-xlarge" type="password" name="xpass" id="xpass" value="${xpass }" placeholder="请输入您的新密码" />
				<button class="btn-u pull-right" type="submit">获取认证码</button>
			</div>
			</form>
			
			<form class="log-page" action="${pageContext.request.contextPath}/updateUpassTwo.htmlx">

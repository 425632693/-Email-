...
<body>
	...
	<div class="breadcrumbs margin-bottom-40">
		<div class="container">
			<h1 class="color-green pull-left">景点上传</h1>
			<ul class="pull-right breadcrumb">
				<li><a href="index.jsp">首页</a> <span class="divider">/</span></li>
				<li class="active">景点上传</li>
			</ul>
		</div>
	</div>
	<!--=== 面包屑导航结束 ===-->
	...
	<div class="container">
		<div class="row-fluid">
			<form class="log-page" action="${pageContext.request.contextPath}/upload.htmlx" 
				method="post" enctype="multipart/form-data"/>
				<h3>景点上传</h3>
				<h5><font color="red">${errors}</font></h5>
				<h5><font color="blue">${success}</font></h5>
				<div class="input-prepend">
					<span class="add-on"><i class="icon-user">景点名称</i></span> 
						<input class="input-xlarge" type="text" name="jdName" placeholder="请输入景点名称" />
				</div>
				<div class="input-prepend">
					<span class="add-on"><i class="icon-lock">景点介绍</i></span> <input
						class="input-xlarge" type="text" name="jdContent" placeholder="请输入景点的简介" />
				</div>
				<div class="input-prepend">
					<span class="add-on"><i class="icon-lock">景点所在省</i></span> <input
						class="input-xlarge" type="text" name="province" placeholder="请输入景点的所在省" />
				</div>
				<div class="input-prepend">
					<span class="add-on"><i class="icon-lock">景点图片</i></span> 
					<input class="input-xlarge" type="file" name="jdImage1"/>
				</div>

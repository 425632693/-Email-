...
<body>
	...
	<div class="breadcrumbs margin-bottom-40">
		<div class="container">
			<h1 class="color-green pull-left">修改邮箱</h1>
	...
	<div class="container">
		<div class="row-fluid">
			...
			<form class="log-page" action="${pageContext.request.contextPath}/getEmailCode.htmlx"/>
			<div class="input-prepend">
				<span class="add-on">Email:</span> 
				<input class="input-xlarge" type="text" name="email" readonly="readonly" value="${email}"/>
			</div>
			<div class="input-prepend">
				<span class="add-on">密码:</span> 
				<input class="input-xlarge" type="password" name="upass" id="upass" value="${upass }" placeholder="请输入您的密码" />
			</div>
			<div class="input-prepend">
				<span class="add-on">新邮箱:</span> 
				<input class="input-xlarge" type="text" name="xemail" id="xemail" value="${xemail }" placeholder="请输入您的新邮箱" />
				<button class="btn-u pull-right" type="submit">获取认证码</button>
			</div>
			</form>
			
			<form class="log-page" action="${pageContext.request.contextPath}/updateEmail.htmlx">
